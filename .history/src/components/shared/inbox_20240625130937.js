        ...
        <div class="d-flex align-items-center justify-content-between mb-auto p-3 osahan-header">
          ...
          <div class="d-flex align-items-center gap-2">
            <a
              ...
              class="text-dark bg-white shadow rounded-circle icon">
              <span class="mdi mdi-square-edit-outline mdi-18px"></span>
            </a>
            <a
              class="toggle text-dark d-flex align-items-center justify-content-center fs-5 bg-white shadow rounded-circle icon"
              href="message.html#">
